    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto px-3 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <div class="mb-6">
                    <h3 class="text-lg font-semibold mb-2">What is Client Fund Management?</h3>
                ...
                <form method="POST" action="{{ route('client-funds.store') }}">
                    ...
                    <!-- Client Name -->
                    <div class="mb-4">
                        <label for="client_name" class="block text-gray-700 dark:text-gray-300 font-semibold mb-2">
                        ...
                        <input
                            ...
                            class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 rounded px-4 py-2 focus:outline-none focus:border-indigo-500"
                            required
                        >
                    ...
                    <!-- Fund Type -->
                    <div class="mb-4">
                        <label for="type" class="block text-gray-700 dark:text-gray-300 font-semibold mb-2">
                            Fund Type <span class="text-red-500">*</span>
                        </label>
                        <div class="space-y-3">
                            <label class="flex items-start p-3 border rounded cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700"
                                ...
                                >
                                <div class="ml-3">
                                    <span class="font-semibold">💰 With Profit/Commission</span>
                            ...
                            <label class="flex items-start p-3 border rounded cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700"
                                ...
                                >
                                <div class="ml-3">
                                    <span class="font-semibold">🔄 No Profit</span>
                                    <p class="text-xs text-gray-600 dark:text-gray-400">
                    ...
                    <!-- Amount Received -->
                    <div class="mb-4">
                        <label for="amount_received" class="block text-gray-700 dark:text-gray-300 font-semibold mb-2">
                    ...
                    <!-- Account -->
                    <div class="mb-4">
                        <label for="account_id" class="block text-gray-700 dark:text-gray-300 font-semibold mb-2">
                    ...
                    <!-- Purpose -->
                    <div class="mb-4">
                        <label for="purpose" class="block text-gray-700 dark:text-gray-300 font-semibold mb-2">
                    ...
                    <!-- Received Date -->
                    <div class="mb-4">
                        <label for="received_date" class="block text-gray-700 dark:text-gray-300 font-semibold mb-2">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button
                            type="submit"
                            class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded focus:outline-none"
                        >
                            Record Client Fund
                        </button>
                    </div>
