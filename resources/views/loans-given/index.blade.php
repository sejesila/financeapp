            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('loans-given.create') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                        <!-- Total Principal -->
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 overflow-hidden shadow-sm rounded-lg border border-blue-200">
                            <div class="p-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-lg font-semibold text-gray-900">KES {{ number_format($totalPrincipal ?? 0, 0) }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Total Repaid -->
                        <div class="bg-gradient-to-br from-green-50 to-green-100 overflow-hidden shadow-sm rounded-lg border border-green-200">
                            <div class="p-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-lg font-semibold text-gray-900">KES {{ number_format($totalRepaid ?? 0, 0) }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Total Interest -->
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100 overflow-hidden shadow-sm rounded-lg border border-purple-200">
                            <div class="p-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-lg font-semibold text-gray-900">KES {{ number_format($totalInterest ?? 0, 0) }}</p>
                        ...
                        <!-- Average Interest -->
                        <div class="bg-gradient-to-br from-pink-50 to-pink-100 overflow-hidden shadow-sm rounded-lg border border-pink-200">
                            <div class="p-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-lg font-semibold text-gray-900">{{ number_format($avgInterestRate ?? 0, 1) }}%</p>
                        ...
                        <!-- Repayment Rate -->
                        <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 overflow-hidden shadow-sm rounded-lg border border-yellow-200">
                            <div class="p-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-lg font-semibold text-gray-900">{{ number_format($repaymentRate ?? 0, 1) }}%</p>
                                        <p class="text-xs text-gray-500">{{ $paidLoans->total() }} of {{ $activeLoans->count() + $paidLoans->total() }} loans</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="space-y-2 text-sm">
                                                <div class="flex justify-between">
                                                    ...
                                                    <span class="font-medium">KES {{ number_format($loan->principal_amount, 0) }}</span>
                                                </div>
                                                <div class="flex justify-between">
                                                    <span class="text-gray-500">Outstanding:</span>
                                                    <span class="font-bold text-indigo-600">KES {{ number_format($loan->balance, 0) }}</span>
                                                </div>
                                                @if($loan->amount_paid > 0)
                                                    <div class="flex justify-between">
                                                        <span class="text-gray-500">Received:</span>
                                                        <span class="text-green-600">KES {{ number_format($loan->amount_paid, 0) }}</span>
                                                    </div>
                                                @endif
                                                <div class="flex justify-between">
                        ...
                        <div class="bg-white rounded-lg border border-gray-200">
                            <div class="p-4 border-b border-gray-200">
                                <div class="flex flex-wrap items-center justify-between gap-4">
                                    ...
                                    <form method="GET" action="{{ route('loans-given.index') }}" class="flex flex-wrap items-center gap-2">
                                        <input type="hidden" name="filter" value="paid">
                                        <select name="period" class="rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" onchange="this.form.submit()">
                                        ...
                                        <input type="date" name="start_date" class="rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" value="{{ $startDate }}">
                                        <input type="date" name="end_date" class="rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" value="{{ $endDate }}">
                                ...
                                <div class="overflow-x-auto">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            ...
                                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Repaid Date</th>
                                        ...
                                        @foreach($paidLoans as $loan)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">KES {{ number_format($loan->principal_amount, 0) }}</td>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                    @if($loan->referrer)
                                                        {{ $loan->referrer->name }}
                                                        @if($loan->interest_amount > 0 && $loan->referrer_share_percentage !== null)
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-green-600">KES {{ number_format($loan->amount_paid, 0) }}</td>
