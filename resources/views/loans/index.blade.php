        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <form method="GET" action="{{ route('loans.index') }}" class="flex flex-wrap gap-2 items-center">
                    <div class="relative">
                        <select name="year" class="block appearance-none w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 p-2 pl-3 pr-8 rounded text-sm bg-white focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="relative">
                        <select name="filter" class="block appearance-none w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 p-2 pl-3 pr-8 rounded text-sm bg-white focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    @if($year || $filter != 'active')
                        <a href="{{ route('loans.index') }}" class="text-gray-600 dark:text-gray-400 text-sm hover:text-gray-800 dark:hover:text-gray-200">
                            Clear
                        </a>
                    @endif
                </form>
                            ...
                            @foreach($activeLoans as $loan)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-right text-gray-900 dark:text-gray-100 font-medium">
                                        {{ number_format($loan->principal_amount, 0, '.', ',') }}
                                    </td>
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <a href="{{ route('loans.payment', $loan->id) }}"
